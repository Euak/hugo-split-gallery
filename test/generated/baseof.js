...
test
    .page `http://127.0.0.1:8080/hugo-split-gallery/posts/lakes-muzelle-lauvitel/index.html`
    ('Only next link should be displayed on first post', async t => {
    await t.expect(Selector('#menu-prevnext').childElementCount).eql(1);
});
test
    .page `http://127.0.0.1:8080/hugo-split-gallery/posts/grand-veymont/index.html`
